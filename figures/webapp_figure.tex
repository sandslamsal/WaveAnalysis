...
\node[panel] (settings) at (0,0) {\includegraphics[width=17cm]{setting.png}};
...
\node[plabel] at (-2.7,-3.05) {(c)\quad Decomposed spectrum};
\node[plabel] at ( 3.1,-3.05) {(d)\quad Per-probe spectrum};
